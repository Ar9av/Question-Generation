...
tf.app.flags.DEFINE_string("data_path", os.environ["PWD"] + "/" + QUESTION_GENERATION_DATA["local"] + "/", "Path to dataset")
tf.app.flags.DEFINE_string("log_directory", os.environ["PWD"] + "/" + QUESTION_GENERATION_DATA["local"][:-4] + "logs/", "Path to logs")
tf.app.flags.DEFINE_string("model_dir", os.environ["PWD"] + "/" + QUESTION_GENERATION_MODEL["local"] + "/", "Path to checkpoints")
...
tf.app.flags.DEFINE_string('c', '', 'gunicorn config flag')
tf.app.flags.DEFINE_string('l', '', 'pyres-manager flag')
tf.app.flags.DEFINE_string('pool', '', 'pyres-manager flag')
tf.app.flags.DEFINE_string('host', '', 'pyres-manager flag')
tf.app.flags.DEFINE_string('port', '', 'pyres-manager flag')
tf.app.flags.DEFINE_string('i', '', 'pyres-manager flag')
tf.app.flags.DEFINE_string('f', '', 'pyres-manager flag')
tf.app.flags.DEFINE_string('minions_interval', '', 'pyres-manager flag')
tf.app.flags.DEFINE_string('concat_minions_logs', '', 'pyres-manager flag')
tf.app.flags.DEFINE_string('disable-warnings', '', 'pytest flags')
tf.app.flags.DEFINE_string('v', '', 'pytest flags')
